...
@section('content')
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="about-heading-content">
                     <h2 class="heading-title">"Uncountable and unrivalled world's largest online and offline fashion
                        house since 1990"</h2>
                  </div>
               </div>
            </div>
            ...
            <div class="row align-items-center">
               <div class="col-lg-6">
                  <div class="about-thumb pos-rel mb-30">
                     <img class="about-thumb-main" src="assets/img/about/about-thumb.jpg" alt="img">
                     <img class="est-time-img" src="assets/img/about/1990.png" alt="img">
                  </div>
               </div>
               <div class="col-lg-6">
      ...
      <!-- features area start  -->
      <div class="features-area features-area4">
         <div class="container container-small">
            <div class="row">
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="features-single mb-30">
                     <div class="irc-item">
      ...
      <section class="speciality-area pt-90">
         <div class="container container-small">
            <div class="row align-items-center">
               <div class="col-lg-6">
                  <div class="speciality-content mb-30">
                     <div class="section-title">
                        <h2 class="section-main-title mb-45">We brought fashion
                           revolution in the society</h2>

                     </div>
                     <div class="speciality-points">
                        <div class="speciality-point-single">
                           <div class="irc-item">
                              <div class="irc-item-icon">
                              ...
                              <div class="irc-item-content">
                                 <div class="irc-item-heading">Western Fashion</div>
                        ...
                        <div class="speciality-point-single">
                           <div class="irc-item">
                              ...
                              <div class="irc-item-content">
                                 <div class="irc-item-heading">Fresh & Comfort</div>
                                 <p>When not in front of her computer screen croix wine in hand or in front of a
                                    mirror
                                 </p>
                              </div>
                        ...
                        <div class="speciality-point-single">
                           <div class="irc-item">
                              ...
                              <div class="irc-item-content">
                                 <div class="irc-item-heading">Cotton & Fabric</div>
                                 <p>When not in front of her computer screen croix wine in hand or in front of a
                                    mirror
                                 </p>
                              </div>
               ...
               <div class="col-lg-6">
                  <div class="speciality-thumb mb-30">
