...
@section('content')
                                            ...
                                            <div class="product-desc">
                                                ...
                                                <ul class="product-color-nav">
                                                    <li class="cl-brown active">
                                                        <img src="{{ asset('assets/img/bag/1.jpg') }}" alt="">
                                                    </li>

                                                    <li class="cl-ash">
                                                        <img src="{{ asset('assets/img/bag/2.jpg') }}" alt="">
                                                    </li>

                                                    <li class="cl-black">
                                                        <img src="{{ asset('assets/img/bag/3.jpg') }}" alt="">
                                                    </li>
                                                </ul>
    ...
    <!-- features area start  -->
    <div class="features-area features-area3">
        <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="product-category2-single pos-rel mb-30">
                            ...
                            <div class="product-category-inner">
                                <div class="product-category-content">
                                    <a href="shop.html" class="product-category">Activewear</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-6 order-xxl-3">
                        <div class="product-category2-single pos-rel mb-30">
                            ...
                            <div class="product-category-inner">
                                <div class="product-category-content">
                                    <a href="shop.html" class="product-category">Hot Dresses</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xxl-6 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-category2-single pos-rel mb-30">
                                    ...
                                    <div class="product-category-inner">
                                        <div class="product-category-content">
                                            <a href="shop.html" class="product-category">Footwear</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-6 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-category2-single pos-rel mb-30">
                                    ...
                                    <div class="product-category-inner">
                                        <div class="product-category-content">
                                            <a href="shop.html" class="product-category">Sunglass</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-6 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-category2-single pos-rel mb-30">
                                    ...
                                    <div class="product-category-inner">
                                        <div class="product-category-content">
                                            <a href="shop.html" class="product-category">Coat & Jacket</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-6 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-category2-single pos-rel mb-30">
                                    ...
                                    <div class="product-category-inner">
                                        <div class="product-category-content">
                                            <a href="shop.html" class="product-category">Jewelry</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- product area start  -->
    <section class="product-area pt-120 pb-90">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="section-title text-center">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                <div class="product-image pos-rel">
                                                    <a href="shop-details.html" class=""><img src="assets/img/bag/1.jpg"
                                                            alt="img"></a>
                                                    <div class="product-action-bottom">
                                                        <a href="#" class="quick-view-btn"><i class="fal fa-eye"></i></a>
                                                        <a href="cart.html" class="add-cart-btn"><i
                                                    ...
                                                    <div class="product-nav">
                                                        <div class="product-nav-prev"><i class="fal fa-angle-left"></i>
                                                        </div>
                                                        <div class="product-nav-next"><i class="fal fa-angle-right"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Varsi Leather
                                                            Bag</a>
                                                    </div>
                                                    <div class="product-price">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                <div class="product-image pos-rel">
                                                    <a href="shop-details.html" class=""><img
                                                ...
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Fit Twill Shirt
                                                            for
                                                            Woman</a>
                                                    </div>
                                                    <div class="product-price">
                                                        <span class="price-now">£62.00</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                ...
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Grand Atlantic
                                                            Chukka
                                                            Boots</a>
                                                    </div>
                                                    <div class="product-price">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                ...
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Women's Faux-Trim
                                                            Shirt</a>
                                                    </div>
                                                    <div class="product-price">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                ...
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Soft Touch
                                                            Interlock
                                                            Polo</a>
                                                    </div>
                                                    <div class="product-price">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                <div class="product-image pos-rel">
                                                    <a href="shop-details.html" class=""><img
                                                            src="assets/img/product/product-img1.jpg" alt="img"></a>
                                                ...
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Ecomart Smart
                                                            Watch</a>
                                                    </div>
                                                    <div class="product-price">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                <div class="product-image pos-rel">
                                                    <a href="shop-details.html" class=""><img
                                                            src="assets/img/sunglass/2.jpg" alt="img"></a>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                <div class="product-image pos-rel">
                                                    <a href="shop-details.html" class=""><img src="assets/img/shirt/2/1.jpg"
                                                            alt="img"></a>
                                                ...
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Cotton Shirt fot
                                                            Men</a>
                                                    </div>
                                                    <div class="product-price">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                ...
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Double-breasted
                                                            Blazer</a>
                                                    </div>
                                                    <div class="product-price">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                ...
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Ribbed Cotton
                                                            Bodysuits</a>
                                                    </div>
                                                    <div class="product-price">
                                ...
                                <div class="product-tab-slider swiper-container">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                <div class="product-image pos-rel">
                                                    <a href="shop-details.html" class=""><img src="assets/img/pant/1/1.jpg"
                                                            alt="img"></a>

                                                    <div class="product-action-bottom">
                                                        <a href="#" class="quick-view-btn"><i class="fal fa-eye"></i></a>
                                                        <a href="cart.html" class="add-cart-btn"><i
                                                                class="fal fa-shopping-bag"></i>Add to
                                                            Cart</a>
                                                        <a href="#" class="wishlist-btn"><i class="fal fa-heart"></i></a>
                                                    </div>
                                                    <div class="product-nav">
                                                ...
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Skinny Jeans
                                                            Pant</a>
                                                    </div>
                                                    <div class="product-price">
                                                        <span class="price-now">£45.00</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                <div class="product-image pos-rel">
                                                    <a href="shop-details.html" class=""><img src="assets/img/pant/2/1.jpg"
                                                            alt="img"></a>
                                                ...
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Men's Flat-Front
                                                            Shorts</a></div>
                                                    <div class="product-price">
                                                        <span class="price-now">£30.00</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                <div class="product-image pos-rel">
                                                    <a href="shop-details.html" class=""><img src="assets/img/shoe/1.jpg"
                                                            alt="img"></a>
                                                ...
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Eastland Lumber Up
                                                            Boots</a>
                                                    </div>
                                                    <div class="product-price">
                                ...
                                <div class="product-tab-slider swiper-container">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                <div class="product-image pos-rel">
                                                    <a href="shop-details.html" class=""><img src="assets/img/shirt/1/1.jpg"
                                                            alt="img"></a>
                                                ...
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Comfy Winter
                                                            Shirt</a>
                                                    </div>
                                                    <div class="product-price">
                                ...
                                <div class="product-tab-slider swiper-container">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product single-product-st2">
                                                <div class="product-image pos-rel">
                                                    <a href="shop-details.html" class=""><img src="assets/img/shirt/3/1.jpg"
                                                            alt="img"></a>
                                                ...
                                                <div class="product-desc">
                                                    <div class="product-name"><a href="shop-details.html">Men's Poplin Dress
                                                            Shirt</a>
                                                    </div>
                                                    <div class="product-price">
                                                        <span class="price-now">£25.00</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="category-banner-single category-banner2 mb-30 pos-rel">
                        <div class="category-banner-img">
                            <img src="assets/img/category_banner/category-banner5.jpg" alt="banner-img">
                        </div>
                        <div class="category-banner-inner">
                            <div class="category-banner-content">
                                <a href="shop.html" class="product-category"><span>Exclusive Jacket</span>
                                    Collection</a>
                                <p class="category-short-desc">Start from : <span>£258.00</span></p>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="category-banner-single category-banner2 mb-30 pos-rel">
                        <div class="category-banner-img">
                            <img src="assets/img/category_banner/category-banner6.jpg" alt="banner-img">
                        </div>
                        <div class="category-banner-inner">
                            <div class="category-banner-content">
                                <a href="shop.html" class="product-category"><span>Hot Exclusive</span>
                                    Offer on Jewelry</a>
                                <p class="category-short-desc"><span>50%</span> Instant Discount</p>
                                <a href="shop.html" class="border-btn">Shop Now</a>
                            </div>
                        </div>
                    </div>
