                                    ...
                                    <div class="contact-list-item">
                                        <div class="irc-item">
                                            ...
                                            <div class="irc-item-content">
                                                ...
                                                @if($settings->phone)
                                                    <span>Mobile : <a
                                                            href="tel:{{ $settings->phone }}"><span>{{ $settings->phone }}</span></a></span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="contact-list-item">
                                        <div class="irc-item">
                                            ...
                                            <div class="irc-item-content">
                                                ...
                                                <span>Email : <a href="mailto:{{ $settings->email }}"><span
                                                            class="__cf_email__">{{ $settings->email }}</span></a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="contact-list-item">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="contact-map-wrapper">
                            <iframe src="{{ $settings->google_map_embed }}" width="100%" height="450" style="border:0;"
